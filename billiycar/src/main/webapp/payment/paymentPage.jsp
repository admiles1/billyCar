...
<!--         <form class="needs-validation" > -->
    <h5 class="subject">예약정보</h5>
    	<div class="row g-3">
       		<div class="col-sm-3">
            	<label class="form-label">대여날짜</label>
            </div>
        ...
        <div class="row g-3">
        	<div class="col-sm-3">
       	    	<label for="firstName" class="form-label">대여지역</label>
            </div>
		...
		<div class="row g-3">
			<div class="col-sm-3">
            	<label for="firstName" class="form-label">반납날짜</label>
            </div>
		...
		<div class="row g-3">
			<div class="col-sm-3">
            	<label for="firstName" class="form-label">반납지역</label>
            </div>
		...
		<div class="row g-3">
			<div class="col-sm-3">
            	<label for="firstName" class="form-label">총 대여시간</label>
        	</div>
			...
			<hr>            
           	...
           	<h5 class="subject">운전자정보(필수입력)</h5>
        <div class="row gy-3">
            <div class="col-sm-2">
              		<label for="firstName" class="form-label">운전자명</label>
           	</div>
		...
		<div class="row gy-3">
        	<div class="col-sm-2">
      		...
      		<div class="col-sm-2">
            	<label for="firstName" class="form-label">메일주소</label>
           	</div>
				...
				<tbody>
					...
					<tr class="insuranceChk" >
						<td colspan="1" class="chk" >
							...
							<label for="insuranceCar1" >완전자차</label>
						</td>
		...
		<h5 class="subject">할인정보(중복할인불가)</h5>
		<div class="row g-3">
			<div class="col-sm-9">
