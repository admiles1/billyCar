...
<form id="signup" action="mypage" method="post" name="fr">
	<fieldset>
		...
		<div class="modify-notice">
			<p class="contxt-list">
				회원정보 수정 시 다음 양식을 준수하여 기입해주세요!
			</p>
			<p>이메일은<em> 반드시 @를 포함</em> 하여 입력해주세요.</p>
		...
		<ul>
			...
			<li>
				...
				<input id="tel" name="member_phone" type="tel" value="${info.member_phone}" autocomplete="off" pattern="^[0-9]{10,11}">
			</li>  
		</ul>
