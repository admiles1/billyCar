...
<body>
    <div class="container">
		...
		<hr>
		<form action="forgot_pw_step2_phone" method="post" name="fr">
         <div class="phone"> <input type="hidden" value="${member_id}" name="member_id"></div>
	        <div class="tel">
	            <input type="text" placeholder="이름" class="name" name="phone_member_name" id="phone_member_name" maxlength="5">
	            <br>
...
<!-- 	            </select> -->
	             <input type="text" placeholder="전화번호" class="telephone_num" id="member_phone" name="member_phone" maxlength="11"/>
