...
<div class = "right_menu">
	<c:choose>
			...
			<c:otherwise>
				...
				<a class = "top_menu" href="">로그아웃</a>
				<c:if test="${sessionScope.id eq 'admin'}">
					| <a class = "top_menu" href =""> 관리자페이지</a>
				</c:if>
			</c:otherwise>			
		</c:choose>
</div>
	...
	<header class="top-bar con-min-width">
	  ...
	  <hr id = "top-line">
	    <nav class="top-bar__menu-box-1">
	      <ul>
	        <li>
	          <a class = "top_menu" href="#" style = "position: relavive; z-index: 2">차량 예약</a>
	          <ul>
	            <li><a class = "top_sub_menu"  href="#">실시간 차량 예약</a></li>
	            <li><a class = "top_sub_menu"  href="#">차량 예약 확인</a></li>
	          </ul>
	        </li>
	        <li>
